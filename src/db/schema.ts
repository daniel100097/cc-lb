...
export const accounts = sqliteTable("accounts", {
  ...
  rateLimit5hUtilization: real("rate_limit_5h_utilization"),
  rateLimit5hReset: integer("rate_limit_5h_reset"),
  rateLimit7dUtilization: real("rate_limit_7d_utilization"),
  rateLimit7dReset: integer("rate_limit_7d_reset"),
