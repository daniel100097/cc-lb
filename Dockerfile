...
WORKDIR /app
ENV NODE_ENV=production DB_PATH=/app/data/cc-lb.db CLAUDE_CONFIG_DIR=/app/data/claude CLAUDE_ACCOUNTS_DIR=/app/data/claude-accounts PATH=/app/node_modules/.bin:$PATH
